...
class B2:
     ...
     def ghost_ab(self,gy2,gy3):
          ...
          if gy-gy2<=150:
             ...
             lst_gh.append(gy3)
          return(lst_gh)
pygame.mixer.music.load('03 Before School 1 (1).mp3')
...
while done3:
 while not done:
   ...
   textSurfaceObj = fontObj.render(' Hello newbie, congratulations on your new job. ', True, [10,10,10])
 ...
 boat=pygame.image.load("bbird33.png")
     ...
     for event in pygame.event.get():
          if event.type == pygame.QUIT:
              ...
              if event.key == pygame.K_SPACE :
                 start=1
                 dy=dy-20
                 pygame.mixer.music.load('sfx-4.mp3')
                 pygame.mixer.music.play()
 ...
 pygame.mixer.music.load('chasy_009.mp3')
 pygame.mixer.music.play()
 while Level3:
    goal=5
